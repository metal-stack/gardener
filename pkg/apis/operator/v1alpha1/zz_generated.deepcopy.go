...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GardenletBackup) DeepCopyInto(out *GardenletBackup) {
	*out = *in
	out.SecretRef = in.SecretRef
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GardenletBackup.
func (in *GardenletBackup) DeepCopy() *GardenletBackup {
	if in == nil {
		return nil
	}
	out := new(GardenletBackup)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GardenletSpec) DeepCopyInto(out *GardenletSpec) {
	*out = *in
	...
	if in.GardenletBackup != nil {
		in, out := &in.GardenletBackup, &out.GardenletBackup
		*out = new(GardenletBackup)
		**out = **in
	}
	if in.Gardenlet != nil {
		in, out := &in.Gardenlet, &out.Gardenlet
		*out = new(seedmanagementv1alpha1.Gardenlet)
		(*in).DeepCopyInto(*out)
	}
	return
}
