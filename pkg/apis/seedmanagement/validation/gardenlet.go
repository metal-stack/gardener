...
var availableGardenletOperations = sets.New[string](
...
func ValidateGardenletSpec(spec *seedmanagement.GardenletSpec, fldPath *field.Path) field.ErrorList {
	...
	allErrs = append(allErrs, validation.ValidateHelmControllerDeployment(&spec.Deployment.Helm, fldPath.Child("deployment", "helm"))...)
