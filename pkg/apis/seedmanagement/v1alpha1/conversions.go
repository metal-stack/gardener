...
func Convert_v1_HelmControllerDeployment_To_core_HelmControllerDeployment(in *gardencorev1.HelmControllerDeployment, out *gardencore.HelmControllerDeployment, s conversion.Scope) error {
	return gardencorev1.Convert_v1_HelmControllerDeployment_To_core_HelmControllerDeployment(in, out, s)
}

func Convert_core_HelmControllerDeployment_To_v1_HelmControllerDeployment(in *gardencore.HelmControllerDeployment, out *gardencorev1.HelmControllerDeployment, s conversion.Scope) error {
	return gardencorev1.Convert_core_HelmControllerDeployment_To_v1_HelmControllerDeployment(in, out, s)
}
