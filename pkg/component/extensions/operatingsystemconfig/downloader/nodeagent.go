...
import (
	...
	images "github.com/gardener/gardener/imagevector"
...
// TODO: add doc string
func NodeAgentConfig(oscSecretName, apiServerURL string, clusterCA []byte, imageVector imagevector.ImageVector, worker gardencorev1beta1.Worker, kubernetesVersion *semver.Version) ([]extensionsv1alpha1.Unit, []extensionsv1alpha1.File, error) {
	...
	config := &nodeagentv1alpha1.NodeAgentConfiguration{
		...
		OperatingSystemConfigSecretName: oscSecretName,
		AccessTokenSecretName:           nodeagentv1alpha1.NodeAgentTokenSecretName,
