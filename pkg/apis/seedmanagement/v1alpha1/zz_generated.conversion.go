...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*core.HelmControllerDeployment)(nil), (*v1.HelmControllerDeployment)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_HelmControllerDeployment_To_v1_HelmControllerDeployment(a.(*core.HelmControllerDeployment), b.(*v1.HelmControllerDeployment), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*v1.HelmControllerDeployment)(nil), (*core.HelmControllerDeployment)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HelmControllerDeployment_To_core_HelmControllerDeployment(a.(*v1.HelmControllerDeployment), b.(*core.HelmControllerDeployment), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_GardenletSelfDeployment_To_seedmanagement_GardenletSelfDeployment(in *GardenletSelfDeployment, out *seedmanagement.GardenletSelfDeployment, s conversion.Scope) error {
	...
	if err := Convert_v1_HelmControllerDeployment_To_core_HelmControllerDeployment(&in.Helm, &out.Helm, s); err != nil {
		return err
	}
...
func autoConvert_seedmanagement_GardenletSelfDeployment_To_v1alpha1_GardenletSelfDeployment(in *seedmanagement.GardenletSelfDeployment, out *GardenletSelfDeployment, s conversion.Scope) error {
	...
	if err := Convert_core_HelmControllerDeployment_To_v1_HelmControllerDeployment(&in.Helm, &out.Helm, s); err != nil {
		return err
	}
	out.ImageVectorOverwrite = (*string)(unsafe.Pointer(in.ImageVectorOverwrite))
	out.ComponentImageVectorOverwrite = (*string)(unsafe.Pointer(in.ComponentImageVectorOverwrite))
