...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HugePageConfig) DeepCopyInto(out *HugePageConfig) {
	*out = *in
	if in.HugePages2M != nil {
		in, out := &in.HugePages2M, &out.HugePages2M
		*out = new(int)
		**out = **in
	}
	if in.HugePages1G != nil {
		in, out := &in.HugePages1G, &out.HugePages1G
		*out = new(int)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HugePageConfig.
func (in *HugePageConfig) DeepCopy() *HugePageConfig {
	if in == nil {
		return nil
	}
	out := new(HugePageConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OperatingSystemConfigSpec) DeepCopyInto(out *OperatingSystemConfigSpec) {
	*out = *in
	...
	if in.HugePageConfig != nil {
		in, out := &in.HugePageConfig, &out.HugePageConfig
		*out = new(HugePageConfig)
		(*in).DeepCopyInto(*out)
	}
	in.DefaultSpec.DeepCopyInto(&out.DefaultSpec)
