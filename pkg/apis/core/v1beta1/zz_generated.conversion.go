...
func autoConvert_v1beta1_KubeAPIServerConfig_To_core_KubeAPIServerConfig(in *KubeAPIServerConfig, out *core.KubeAPIServerConfig, s conversion.Scope) error {
	...
	if in.AccessControl != nil {
		...
		*out = new(core.AccessControl)
		if err := Convert_v1beta1_AccessControl_To_core_AccessControl(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.AccessControl = nil
	}
	return nil
}
...
func autoConvert_core_KubeAPIServerConfig_To_v1beta1_KubeAPIServerConfig(in *core.KubeAPIServerConfig, out *KubeAPIServerConfig, s conversion.Scope) error {
	...
	if in.AccessControl != nil {
		...
		*out = new(AccessControl)
		if err := Convert_core_AccessControl_To_v1beta1_AccessControl(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.AccessControl = nil
...
func autoConvert_v1beta1_Source_To_core_Source(in *Source, out *core.Source, s conversion.Scope) error {
	...
	// WARNING: in.NotIPBlocks requires manual conversion: does not exist in peer-type
	// WARNING: in.RemoteIPBlocks requires manual conversion: does not exist in peer-type
	// WARNING: in.NotRemoteIPBlocks requires manual conversion: does not exist in peer-type
	return nil
}
